...
This directory will hold evidence owned by this repository about its eventual
...
- `cl-001-interval-sweep-dossiers/blinded-material-field-package-t-02.md`
  selects the same `T` field after the T-01 inferability stop and points to a
  revised redacted coded bundle with a new checksum. It does not populate `T`,
  score gate 10, or issue a verdict.
- `cl-001-interval-sweep-dossiers/blind-bundles/cl001-blind-t-02-redacted-source-bundle.md`
  is the revised coded input for a later blind author. It contains no
  unblinding key, does not complete the blind receipt, and keeps inferability as
  the first stop condition.
- `cl-001-interval-sweep-dossiers/blind-bundles/cl001-blind-t-02-inferability-preflight.md`
...
- `cl-001-source-intake.md` defines the primary-source and construction-note
  burden that the retired CL-001 packet files would have needed before packet
  fields, gates, or verdicts could be populated.
...
- `cl-001-source-dossier-manifest.md` queues the packet-specific dossier passes
  for the retired Bitcoin/photosynthesis scaffold only.
- `cl-001-dossiers/` holds draft source extraction records created from the
  dossier template. These records do not populate packet fields or score gates
  by themselves.

Current draft dossiers for the retired scaffold:
