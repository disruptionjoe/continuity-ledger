...
| `cl001-oxygenic-photosynthesis` | `packets/cl-001/oxygenic-photosynthesis.md` | Target case | Primary scientific and biochemical/ecological extraction before packet fields move. | Draft mechanism dossier exists; draft agency-surface dossier exists; biochemical carbon-fixation source selection remains pending. |
...
| Photosynthesis agency-surface dossier | `cl001-oxygenic-photosynthesis` | primary or review | Agency surface and action space; class-relative no-go or constraint; feedback and recurrence; absorber and null pressure; falsifiers and open fields. | Draft dossier: `evidence/cl-001-dossiers/photosynthesis-agency-surface.md`. |
...
That marker remains for any source lane not yet represented by a draft dossier
and for any later packet-population burden that requires a narrower source than
the draft dossier provides.
