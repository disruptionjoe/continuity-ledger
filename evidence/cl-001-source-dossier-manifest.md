...
|---|---|---|---|---|
| `cl001-bitcoin-proof-of-work` | `packets/cl-001/bitcoin-proof-of-work.md` | Target case | Protocol-level and participant-surface extraction before packet fields move. | Pending exact source selection. |
| `cl001-oxygenic-photosynthesis` | `packets/cl-001/oxygenic-photosynthesis.md` | Target case | Primary scientific and biochemical/ecological extraction before packet fields move. | Pending exact source selection. |
| `cl001-null-hash-without-agency-surface` | `packets/cl-001/null-hash-without-agency-surface.md` | Matched null | Construction and absorber extraction under the same lane burden as target cases. | Pending exact source selection. |
| `cl001-null-solar-heating-inert-matter` | `packets/cl-001/null-solar-heating-inert-matter.md` | Matched null | Construction and absorber extraction under the same lane burden as target cases. | Pending exact source selection. |
...
|---|---|---|---|---|
| Bitcoin protocol mechanism dossier | `cl001-bitcoin-proof-of-work` | protocol | Mechanism and transition boundary; regime and class definition; typed measurement family; absorber and null pressure. | Pending exact source selection. |
| Bitcoin participant-surface dossier | `cl001-bitcoin-proof-of-work` | construction or primary | Loss and import accounting; agency surface and action space; class-relative no-go or constraint; feedback and recurrence; falsifiers and open fields. | Pending exact source selection. |
| Photosynthesis mechanism dossier | `cl001-oxygenic-photosynthesis` | primary | Mechanism and transition boundary; typed measurement family; loss and import accounting; falsifiers and open fields. | Pending exact source selection. |
