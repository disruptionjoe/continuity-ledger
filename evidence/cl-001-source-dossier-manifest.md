...
|---|---|---|---|---|
| `cl001-bitcoin-proof-of-work` | `packets/cl-001/bitcoin-proof-of-work.md` | Target case | Protocol-level and participant-surface extraction before packet fields move. | Draft protocol-mechanism dossier exists; participant-surface extraction remains pending exact source selection. |
